...
public class ApplicationProgrammaticConfig {
  public static void main(String[] args) {
    handleArgs(args);
    initialize();
    System.out.println(I18n.translate("Hello and welcome!"));
    System.out.println(I18n.context("action-duck").description("Seeing a person duck").translate("I saw her duck"));
  ...
  private static void initialize() {
    ...
    config.basePath("i18n")
        .defaultLocale("nb")
        .enableCaching(true)
        .enableFallback(true)
        .messageSourceType(FluentConfig.MessageSourceType.BINARY);
    I18n.initialize();
  }
